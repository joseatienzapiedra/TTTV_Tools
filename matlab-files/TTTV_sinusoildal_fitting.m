...
fase_min=(TTV_fase-1)*pi/180;
fase_max=(TTV_fase+1)*pi/180;
...
while Aux_flag
    ...
    elseif (err2 < err1) && (TTV_fase-0.00001 > fase_min)
        TTV_fase=TTV_fase-0.00001;
        err(j)=err2;
    elseif (round(err2*10000)/10000 == round(err1*10000)/1000) && (TTV_fase+0.0001 < fase_max)
        TTV_fase=TTV_fase+0.0001;
        err(j)=err1;
    end
